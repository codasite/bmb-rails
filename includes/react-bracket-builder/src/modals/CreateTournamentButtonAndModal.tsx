...
export const CreateTournamentButtonAndModal = (props: {
  ...
  return <>
    <button
      className="tw-border-solid tw-border tw-border-white tw-bg-white/15 tw-flex tw-gap-16 tw-items-center tw-justify-center tw-rounded-8 tw-p-16 hover:tw-bg-white hover:tw-text-black tw-font-sans tw-text-white tw-uppercase tw-w-full"
 ...
 invite & compete with friends.`}</h1>
        <a href={props.myTemplatesUrl}
          className="tw-border-solid tw-border tw-border-green tw-bg-green/15 tw-flex tw-gap-16 tw-items-center tw-justify-center tw-rounded-8 md:tw-p-40 hover:tw-text-white/75 tw-font-sans tw-text-white tw-uppercase tw-w-full tw-text-20 tw-font-500 tw-mb-15 tw-p-20">
          <FileIcon/><span>Use a template</span>
        </a>
        <a href={props.bracketTemplateBuilderUrl}
          className="tw-border-solid tw-border tw-border-white tw-bg-white/15 tw-flex tw-gap-16 tw-items-center tw-justify-center tw-rounded-8 md:tw-p-40 hover:tw-text-white/75 tw-font-sans tw-text-white tw-uppercase tw-w-full tw-text-20 tw-font-500 tw-mb-15 tw-p-20">
          <PlusIcon/><span>Start from scratch</span>
        </a>
        <button
          onClick={() => setShow(false)}
          className="tw-bg-white/15 tw-flex tw-gap-16 tw-items-center tw-justify-center tw-rounded-8 tw-p-12 tw-border-none hover:tw-text-white/75 tw-font-sans tw-text-white tw-uppercase tw-w-full tw-text-16 tw-font-500">
          Cancel
        </button>
      </div>
    </div>}
