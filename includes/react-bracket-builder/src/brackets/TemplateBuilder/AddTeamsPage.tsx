...
export const AddTeamsPage = (props: AddTeamsPageProps) => {
	...
	return (
		<div className='tw-flex tw-flex-col tw-bg-no-repeat tw-bg-top tw-bg-cover' style={{ 'background': `url(${iconBackground}), #000225` }}>
			<div className='tw-px-60'>
				<a className='tw-flex tw-gap-10 tw-color-white tw-p-16'>
					<ArrowNarrowLeft />
