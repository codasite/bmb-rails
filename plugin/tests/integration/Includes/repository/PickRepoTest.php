...
class PickRepoTest extends WPBB_UnitTestCase {
  ...
  public function test_should_return_correct_most_popular_picks() {
    ...
    $this->assertEquals(66, $most_popular_picks[0]->popularity);
    ...
    $this->assertEquals(100, $most_popular_picks[1]->popularity);
    ...
    $this->assertEquals(66, $most_popular_picks[2]->popularity);
  }
