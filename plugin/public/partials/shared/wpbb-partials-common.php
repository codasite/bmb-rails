 ...
 */
function view_play_btn($endpoint, $label = 'View Play') {
	ob_start();
?>
	<a class="tw-flex tw-items-center tw-justify-center tw-text-white tw-px-16 tw-py-12 tw-rounded-8 tw-border tw-border-solid tw-border-transparent tw-bg-dd-blue/80 hover:tw-bg-transparent hover:tw-text-dd-blue tw-bg-clip-padding tw-h-full tw-w-full" href="<?php echo esc_url($endpoint) ?>">
