	...
	<div class="tw-flex tw-justify-between sm:tw-px-30<?php echo $winner ? ' tw-border-2 tw-border-solid tw-border-green tw-rounded-16 tw-py-30' : '' ?>">
		<div class="tw-flex tw-flex-col tw-gap-16">
			...
			<div class="tw-flex tw-gap-<?php echo $winner ? '20' : '16' ?>">
				...
				<div class="wpbb-lb-winning-team-name-container tw-min-w-[100px] tw-px-8 tw-text-center tw-py-4 tw-bg-white tw-text-dd-blue tw-font-700 <?php echo $winner ? 'tw-text-20' : 'tw-text-16' ?>" data-team-name="<?php echo esc_html($winning_team_name)?>" >
