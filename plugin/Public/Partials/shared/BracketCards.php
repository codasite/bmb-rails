...
class BracketCards {
  public static function vip_switcher($bracket_or_play) {
    if ($bracket_or_play instanceof Bracket) {
      return self::vip_bracket_card($bracket_or_play, [
        'show_profile_link' => true,
      ]);
    } elseif ($bracket_or_play instanceof Play) {
      return self::vip_play_card($bracket_or_play, [
        'show_profile_link' => true,
      ]);
    }
  }
  ...
  public static function vip_play_card($play, $options = []): false|string {
    ...
    $buttons = [
      ...
      BracketsCommon::leaderboard_btn(
        $leaderboard_link,
        'primary',
        'Leaderboard'
      ),
  ...
  public static function vip_card(
    $title,
    $thumbnail,
    array $options = []
  ): false|string {
    ...
    <div class="tw-flex tw-flex-col">
      <div class="tw-relative tw-bg-center tw-bg-cover tw-bg-no-repeat tw-bg-white tw-rounded-t-16 tw-min-h-[324px] sm:tw-grow" style="background-image: url(<?php echo $thumbnail; ?>)">
        ...
        <div
          ...
          <h3 class="tw-text-30 tw-text-black"><?php echo esc_html(
            $title
          ); ?></h3>
        </div>
      </div>
