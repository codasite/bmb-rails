...
switch ($current_tab) {
	case 'profile':
		...
		break;
	case 'brackets':
		$template = 'my-brackets.php';
		break;
	case 'play-history':
		$template = 'my-play-history.php';
		break;
	default:
		$template = 'my-profile.php';
		break;
...
function get_nav_link($tab, $current_tab, $label, $icon) {
...
<div class="wpbb-dashboard tw-text-white tw-font-sans tw-flex tw-flex-col md:tw-flex-row tw-gap-30 lg:tw-gap-60 leading-none tw-uppercase tw-max-w-screen-xl tw-mx-auto tw-px-20">
	<nav>
		...
		<ul class="tw-flex tw-flex-col tw-gap-15 tw-p-0 tw-m-0">
			<li class="tw-font-500 tw-text-20 tw-list-none"><?php echo get_nav_link('profile', $current_tab, 'Profile', '../../assets/icons/user.svg'); ?></li>
			<li class="tw-font-500 tw-text-20 tw-list-none"><?php echo get_nav_link('brackets', $current_tab, 'My Brackets', '../../assets/icons/signal.svg'); ?></li>
			<li class="tw-font-500 tw-text-20 tw-list-none"><?php echo get_nav_link('play-history', $current_tab, 'My Play History', '../../assets/icons/clock.svg'); ?></li>
		</ul>
	</nav>
