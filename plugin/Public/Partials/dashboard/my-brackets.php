...
function edit_bracket_btn($bracket): false|string {
	...
	$month = $bracket->month;
	$year = $bracket->year;
	return DashboardCommon::icon_btn( 'pencil.svg', 'submit', classes: "wpbb-edit-bracket-button", attributes: "data-bracket-id='$id' data-bracket-title='$title' data-bracket-month='$month' data-bracket-year='$year'" );
}
...
<div class="tw-flex tw-flex-col tw-gap-15">
	<h1 class="tw-mb-8 tw-text-24 sm:tw-text-48 lg:tw-text-64 tw-font-700 tw-leading-none">My Tournaments</h1>
	...
	<div class="tw-flex tw-gap-10 tw-gap-10 tw-py-11">
		<?php echo BracketsCommon::sort_button( 'All', get_permalink() . "brackets/?status=all", $paged_status === 'all' ); ?>
		<?php echo BracketsCommon::sort_button( 'Active', get_permalink() . "brackets/?status=active", $paged_status === 'active' ); ?>
		<?php echo BracketsCommon::sort_button( 'Scored', get_permalink() . "brackets/?status=scored", $paged_status === 'scored' ); ?>
	</div>
	<div class="tw-flex tw-flex-col tw-gap-15">
