...
import { BracketModal, BracketModalMode } from './components/BracketModal'
    ...
    <>
      <tr onClick={handleViewBracket}>
        ...
        <td className="wpbb-bracket-table-action-col">
          ...
          <Button variant="danger" onClick={handleShowDeleteDialog}>
            Delete
          </Button>
        </td>
      </tr>
...
const Settings = () => {
  ...
  const [bracketModalMode, setBracketModalMode] = useState<BracketModalMode>(
    BracketModalMode.View
  )
  ...
  return (
    <Container>
      ...
      <Button
        variant="dark"
        className="mt-6"
        onClick={() => handleShowBracketModal(BracketModalMode.New)}
      >
        New Bracket
      </Button>
      <BracketModal
