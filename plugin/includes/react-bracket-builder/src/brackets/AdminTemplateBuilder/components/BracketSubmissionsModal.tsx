...
const SubmissionRow = (props: SubmissionRowProps) => {
  const { submission, handleViewSub } = props
  return (
...
const SubmissionsTable = (props: SubmissionsTableProps) => {
  const { submissions, handleViewSub } = props
  return (
...
const SubmissionModalBody = (props: SubmissionModalBodyProps) => {
  const { bracketId, submissions } = props
  ...
  if (activeSub !== null) {
    ...
    return <Bracket matchTree={matchTree} />
  }
  return (
...
export const BracketSubmissionsModal = (
  props: BracketSubmissionsModalProps
) => {
  const { show, handleClose, bracketId } = props
  const [submissions, setSubmissions] =
    useState<Nullable<SubmissionRes[]>>(null)
  ...
  return (
    ...
    >
      ...
      <Modal.Footer className="wpbb-bracket-modal__footer">
        ...
        <Button
          variant="secondary"
          className="wpbb-bracket-modal-close-btn"
          onClick={handleClose}
        >
          Close
        </Button>
