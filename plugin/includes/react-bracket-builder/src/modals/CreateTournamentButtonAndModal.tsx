...
export const CreateTournamentButtonAndModal = (props: {
 ...
 invite & compete with friends.`}</h1>
        ...
        {!props.canCreateTournament && <div className="tw-text-center">
          <LogoDark/>
          <div className="tw-flex tw-items-end tw-justify-center tw-mt-24">
            <span className="tw-text-24">$</span><span className="tw-text-64 tw-font-700 tw-leading-none">99</span>
          </div>
          ...
          <ul className="tw-list-none tw-p-0 tw-m-0 tw-text-16 tw-font-700">
            <li className="tw-flex tw-gap-10 tw-items-center tw-justify-center tw-py-4"><CheckIcon className="tw-text-red"/><span>Host and score tournaments</span></li>
            <li className="tw-flex tw-gap-10 tw-items-center tw-justify-center tw-py-4"><CheckIcon className="tw-text-red"/><span>Invite and compete with friends</span></li>
          </ul>
          <a href={props.upgradeAccountUrl}
