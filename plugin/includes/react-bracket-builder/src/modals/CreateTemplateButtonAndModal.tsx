  ...
  return (
    <form onSubmit={handleSubmit}>
      <input
        ...
        type="text" placeholder="MY BRACKET TITLE..." value={name} onChange={e => setName(e.target.value)}
      />
      <button
...
export const CreateTemplateButtonAndModal = (props: {
  ...
  return <>
    <button className="tw-h-40 tw-w-40 tw-p-8 tw-bg-white/15 tw-border-none tw-text-white tw-flex tw-flex-col tw-items-center tw-justify-center tw-rounded-8 hover:tw-cursor-pointer hover:tw-bg-white hover:tw-text-black"
    ...
    <Modal show={show} setShow={setShow}>
      <div>
        ...
        <EditTemplateForm templateUrl={props.templateUrl} onClose={() => setShow(false)}/>
        {cancelButton}
        </div>
    </Modal>
  </>
